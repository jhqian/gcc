...
(define_insn "riscv_frflags<mode>"
  [(set (match_operand:X 0 "register_operand" "=r")
        (unspec_volatile:X [(const_int 0)] UNSPECV_FRFLAGS))]
  "TARGET_HARD_FLOAT || TARGET_ZFINX"
  "frflags\t%0"
  [(set_attr "type" "fmove")])

(define_insn "riscv_fsflags<mode>"
  [(set (match_operand:X 0 "register_operand" "=r, r")
        (unspec_volatile:X [(match_operand:X 1 "csr_operand" "r, K")] UNSPECV_FSFLAGS))]
  "TARGET_HARD_FLOAT || TARGET_ZFINX"
  "@
   fsflags\t%0, %1
   fsflagsi\t%0, %1"
...
(define_insn "riscv_fwflags<mode>"
  [(unspec_volatile:X [(match_operand:X 0 "csr_operand" "r, K")] UNSPECV_FWFLAGS)]
  "TARGET_HARD_FLOAT || TARGET_ZFINX"
  "@
   fsflags\tx0, %0
   fsflagsi\tx0, %0"
...
(define_insn "riscv_csrr<mode>"
  [(set (match_operand:X 0 "register_operand" "=r")
        (unspec_volatile:X [(match_operand:X 1 "immediate_operand" "i")] UNSPECV_CSRR))]
  ""
  "csrr\t%0, %D1"
  [(set_attr "type" "move")])
...
(define_expand "riscv_get_current_sp<mode>"
  [(match_operand:X 0 "register_operand" "")]
  ""
{
  emit_move_insn (operands[0], gen_rtx_REG (<MODE>mode, SP_REGNUM));
  DONE;
})

(define_expand "riscv_set_current_sp<mode>"
  [(match_operand:X 0 "register_operand" "")]
  ""
{
  emit_move_insn (gen_rtx_REG (<MODE>mode, SP_REGNUM), operands[0]);
  DONE;
})
...
(define_insn "riscv_ebreak<mode>"
  [(unspec_volatile:X [(match_operand:X 0 "ecall_register_operand" "e")] UNSPECV_SBREAK)]
  ""
  "ebreak"
  [(set_attr "type" "trap")])
...
(define_insn "riscv_frcsr<mode>"
  [(set (match_operand:X 0 "register_operand" "=r")
        (unspec_volatile:X [(const_int 0)] UNSPECV_FRCSR))]
  "TARGET_HARD_FLOAT || TARGET_ZFINX"
  "frcsr\t%0"
  [(set_attr "type" "fmove")])

(define_insn "riscv_fscsr<mode>"
  [(set (match_operand:X 0 "register_operand" "=r")
	(unspec_volatile:X [(match_operand:X 1 "register_operand" "r")] UNSPECV_FSCSR))]
  "TARGET_HARD_FLOAT || TARGET_ZFINX"
  "fscsr\t%0,%1"
  [(set_attr "type" "fmove")])

(define_insn "riscv_fwcsr<mode>"
  [(unspec_volatile:X [(match_operand:X 0 "register_operand" "r")] UNSPECV_FWCSR)]
  "TARGET_HARD_FLOAT || TARGET_ZFINX"
  "fscsr\tx0, %0"
  [(set_attr "type" "fmove")])
...
(define_insn "riscv_amoswapw<mode>"
  [(set (match_operand:SI 0 "register_operand" "=r")
        (unspec_volatile:SI [(match_operand:SI 1 "register_operand" "r")
			     (mem:SI (match_operand:GPR 2 "register_operand" "r"))
...
(define_insn "riscv_amo<amo_optab>w<mode>"
  [(set (match_operand:SI 0 "register_operand" "=r")
...
(define_insn "riscv_amo<amo_optab>d"
  [(set (match_operand:DI 0 "register_operand" "=r")
