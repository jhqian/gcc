...
(include "vector-iterators-bf16ms.md")
...
(define_mode_iterator VF_ZVFBF16 [
  (RVVM8BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16 || TARGET_BF16MS)")
  (RVVM4BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16 || TARGET_BF16MS)")
  (RVVM2BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16 || TARGET_BF16MS)")
  (RVVM1BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16 || TARGET_BF16MS)")
  (RVVMF2BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16 || TARGET_BF16MS)")
  (RVVMF4BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16 || TARGET_BF16MS) && TARGET_MIN_VLEN > 32")
])
...
(define_mode_iterator VEEWEXT2 [
  ...
  (RVVM8BF "TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16")
  (RVVM4BF "TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16")
  (RVVM2BF "TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16")
  (RVVM1BF "TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16")
  (RVVMF2BF "TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16")
  (RVVMF4BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16) && TARGET_MIN_VLEN > 32")
...
(define_mode_iterator VEEWTRUNC4 [
  ...
  (RVVM1BF "TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16")
  (RVVMF2BF "TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16")
  (RVVMF4BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16) && TARGET_MIN_VLEN > 32 && TARGET_64BIT")
...
(define_mode_iterator VEI16 [
  ...
  (RVVM8BF "TARGET_BF16MS") (RVVM4BF "TARGET_BF16MS") (RVVM2BF "TARGET_BF16MS")
  (RVVM1BF "TARGET_BF16MS") (RVVMF2BF "TARGET_BF16MS")
  (RVVMF4BF "TARGET_BF16MS && TARGET_MIN_VLEN > 32")
...
(define_mode_iterator V_WHOLE [
  ...
  (RVVM8BF "TARGET_ZVFBFMIN || TARGET_BF16 || TARGET_BF16MS") (RVVM4BF "TARGET_ZVFBFMIN || TARGET_BF16 || TARGET_BF16MS")
  (RVVM2BF "TARGET_ZVFBFMIN || TARGET_BF16 || TARGET_BF16MS") (RVVM1BF "TARGET_ZVFBFMIN || TARGET_BF16 || TARGET_BF16MS")
...
(define_mode_iterator V_FRACT [
  ...
  (RVVMF2BF "TARGET_ZVFBFMIN || TARGET_BF16MS || TARGET_BF16") (RVVMF4BF "(TARGET_ZVFBFMIN || TARGET_BF16MS || TARGET_BF16) && TARGET_MIN_VLEN > 32")
...
(define_mode_iterator V1T [
  ...
  (RVVMF4x2BF "TARGET_MIN_VLEN > 32 && (TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF4x3BF "TARGET_MIN_VLEN > 32 && (TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF4x4BF "TARGET_MIN_VLEN > 32 && (TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF4x5BF "TARGET_MIN_VLEN > 32 && (TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF4x6BF "TARGET_MIN_VLEN > 32 && (TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF4x7BF "TARGET_MIN_VLEN > 32 && (TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF4x8BF "TARGET_MIN_VLEN > 32 && (TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
...
(define_mode_iterator V2T [
  ...
  (RVVMF2x2BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF2x3BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF2x4BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF2x5BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF2x6BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF2x7BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVMF2x8BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
...
(define_mode_iterator V4T [
  ...
  (RVVM1x2BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM1x3BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM1x4BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM1x5BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM1x6BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM1x7BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM1x8BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
...
(define_mode_iterator V8T [
  ...
  RVVM2x4HI
  RVVM4x2SI
  (RVVM2x2BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM2x3BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
  (RVVM2x4BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
...
(define_mode_iterator V16T [
  ...
  RVVM2x4QI
  RVVM4x2HI
  (RVVM4x2BF "(TARGET_VECTOR_ELEN_BF_16 || TARGET_BF16MS || TARGET_BF16)")
...
(define_mode_iterator VLS [VLSI VLSF_ZVFHMIN VLSF_BF16])
...
(define_mode_iterator V_VLSF_ZVFHMIN [VF_ZVFHMIN VLSF_ZVFHMIN VF_ZVFBF16 VLSF_BF16])
...
(define_mode_attr VQSUBEL [
  ...
  ;; VLS modes.
  (V1SI "QI") (V2SI "QI") (V4SI "QI") (V8SI "QI") (V16SI "QI") (V32SI "QI")
  (V64SI "QI") (V128SI "QI") (V256SI "QI") (V512SI "QI") (V1024SI "QI")
  (V1DI "HI") (V2DI "HI") (V4DI "HI") (V8DI "HI") (V16DI "HI") (V32DI "HI")
  (V64DI "HI") (V128DI "HI") (V256DI "HI") (V512DI "HI")
])
...
(define_mode_iterator QVI [
  RVVM8QI RVVM4QI RVVM2QI RVVM1QI
  RVVMF2QI RVVMF4QI (RVVMF8QI "TARGET_MIN_VLEN > 32")
])

(define_mode_attr V_QUAD [
  (RVVM8SI "RVVM8QI") (RVVM4SI "RVVM4QI") (RVVM2SI "RVVM2QI") (RVVM1SI "RVVM1QI") (RVVMF2SI "RVVMF2QI")

  (RVVM8DI "RVVM8HI") (RVVM4DI "RVVM4HI") (RVVM2DI "RVVM2HI") (RVVM1DI "RVVM1HI")
