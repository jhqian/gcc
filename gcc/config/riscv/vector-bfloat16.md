...
(define_insn "@pred_vfncvt_bf16<mode>"
  [(set (match_operand:<V_DOUBLE_TRUNC_BF> 0 "register_operand"   "=&vr,  &vr")
     (if_then_else:<V_DOUBLE_TRUNC_BF>
       (unspec:<VM>
         [(match_operand 3 "vector_length_operand"                 "rK,   rK")
          ...
          (reg:SI VL_REGNUM)
          (reg:SI VTYPE_REGNUM)
          (reg:SI FRM_REGNUM)] UNSPEC_VFCVTBF16)
       (float_truncate:<V_DOUBLE_TRUNC_BF>
          (match_operand:VWEXTBF 2 "register_operand"              "vr,   vr"))
       (match_operand:<V_DOUBLE_TRUNC_BF> 1 "vector_merge_operand" "vu,    0")))]
...
(define_insn "@pred_vfwcvt_bf16<mode>"
    ...
    (if_then_else:VWEXTBF
      (unspec_volatile:<VM>
        [(match_operand 3 "vector_length_operand"                 "   rK,   rK")
         ...
         (match_operand 5 "const_int_operand"                     "    i,    i")
         (reg:SI VL_REGNUM)
         (reg:SI VTYPE_REGNUM)] UNSPEC_VFCVTBF16)
      (float_extend:VWEXTBF
         (match_operand:<V_DOUBLE_TRUNC_BF> 2 "register_operand" "   vr,   vr"))
      (match_operand:VWEXTBF 1 "vector_merge_operand"        "   vu,    0")))]
  "TARGET_VECTOR && TARGET_BF16"
