...
(define_mode_iterator VQIHI [(DSPV4QI "!TARGET_64BIT") (DSPV2HI "!TARGET_64BIT")
                             (DSPV8QI "TARGET_64BIT") (DSPV4HI "TARGET_64BIT")])

(define_mode_iterator VECI [(DSPV4QI "!TARGET_64BIT") (DSPV2HI "!TARGET_64BIT")
                            (DSPV8QI "TARGET_64BIT") (DSPV4HI "TARGET_64BIT")
			    (DSPV2SI "TARGET_64BIT")])

(define_mode_iterator VSHI [(DSPV2HI "!TARGET_64BIT") (DSPV2SI "TARGET_64BIT")])

(define_mode_iterator DSP_VHI [(DSPV2HI "!TARGET_64BIT") (DSPV4HI "TARGET_64BIT")])

(define_mode_iterator DSP_VQI [(DSPV4QI "!TARGET_64BIT") (DSPV8QI "TARGET_64BIT")])

(define_mode_iterator VD_SI [(SI "!TARGET_64BIT") (DSPV2SI "TARGET_64BIT")])

(define_mode_iterator VHIX [DSPV2HI (DSPV4HI "TARGET_64BIT")
                            SI (DI "TARGET_64BIT")])

(define_mode_iterator VQIX [DSPV4QI (DSPV8QI "TARGET_64BIT")
                            SI (DI "TARGET_64BIT")])

;; Give the number of DSP instructions in the mode
(define_mode_attr bits [(DSPV8QI "8") (DSPV4QI "8") (QI "8") (DSPV4HI "16") (DSPV2HI "16")
			(HI "16") (DSPV2SI "32") (DI "64")])

(define_mode_attr bsize [(HI "8") (SI "16")])

(define_mode_attr VSH_EXT [(DSPV2SI "DI") (DSPV2HI "HI")])

(define_mode_attr VELT [(DSPV4QI "QI") (DSPV2HI "HI") (DSPV8QI "QI") (DSPV4HI "HI")])

(define_mode_attr VEXT [(DSPV4QI "DSPV4HI") (DSPV2HI "DSPV2SI") (DSPV8QI "DSPV8HI") (DSPV4HI "DSPV4SI")
			(DSPV2SI "DSPV2DI")])

(define_mode_attr VNHALF [(DSPV2SI "SI") (DSPV2HI "HI")])
...
(define_expand "movdspv2si"
  [(set (match_operand:DSPV2SI 0 "")
       (match_operand:DSPV2SI 1 ""))]
  "TARGET_64BIT && TARGET_DSP"
{
  if (riscv_legitimize_move (DSPV2SImode, operands[0], operands[1]))
    DONE;
})

(define_insn "*movv2si_64bit"
  [(set (match_operand:DSPV2SI 0 "nonimmediate_operand" "=r,r,r, m,  *f,*f,*r,*f,*m")
       (match_operand:DSPV2SI 1 "move_operand"         " r,T,m,rJ,*r*J,*m,*f,*f,*f"))]
  "TARGET_64BIT && TARGET_DSP
   && (register_operand (operands[0], DSPV2SImode)
       || reg_or_0_operand (operands[1], DSPV2SImode))"
  { return riscv_output_move (operands[0], operands[1]); }
  [(set_attr "move_type" "move,const,load,store,mtc,fpload,mfc,fmove,fpstore")
   (set_attr "type" "move,move,load,store,mtc,fpload,mfc,fmove,fpstore")
   (set_attr "mode" "DSPV2SI")])
...
(define_expand "vcras16_64"
  [(match_operand:DSPV4HI 0 "register_operand" "")
   (match_operand:DSPV4HI 1 "register_operand" "")
   (match_operand:DSPV4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_insn "cras16_64_le"
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (minus:HI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
				     (parallel [(const_int 0)]))
		      (vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
				     (parallel [(const_int 1)])))
	    (plus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)]))
		     (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:DSPV2HI
	    (minus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)]))
		      (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (plus:HI  (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)]))
		      (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "cras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
   (set_attr "mode" "DSPV4HI")])

(define_insn "vcras16_64_le"
  [(set (match_operand:DSPV4HI 0 "register_operand"         "=r")
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (minus:HI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
				     (parallel [(const_int 0)]))
		      (vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
				     (parallel [(const_int 1)])))
...
(define_insn "kcras16_64_le"
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (ss_minus:HI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
					(parallel [(const_int 0)]))
			 (vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
					(parallel [(const_int 1)])))
	    (ss_plus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			(vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:DSPV2HI
	    (ss_minus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			 (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (ss_plus:HI  (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			 (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "kcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_insn "vkcras16_64_le"
  [(set (match_operand:DSPV4HI 0 "register_operand"         "=r")
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (ss_minus:HI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
					(parallel [(const_int 0)]))
			 (vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
					(parallel [(const_int 1)])))
...
(define_insn "ukcras16_64_le"
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (us_minus:HI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
					(parallel [(const_int 0)]))
			 (vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
					(parallel [(const_int 1)])))
	    (us_plus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			(vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:DSPV2HI
	    (us_minus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			 (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (us_plus:HI  (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			 (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "ukcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_insn "vukcras16_64_le"
  [(set (match_operand:DSPV4HI 0 "register_operand"         "=r")
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (us_minus:HI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
					(parallel [(const_int 0)]))
			 (vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
					(parallel [(const_int 1)])))
...
(define_insn "crsa16_64_le"
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (plus:HI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
				    (parallel [(const_int 0)]))
		     (vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
				    (parallel [(const_int 1)])))
	    (minus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)]))
		      (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:DSPV2HI
	    (plus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)]))
		     (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (minus:HI  (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)]))
		       (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "crsa16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_insn "vcrsa16_64_le"
  [(set (match_operand:DSPV4HI 0 "register_operand"         "=r")
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (plus:HI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
				    (parallel [(const_int 0)]))
		     (vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
				    (parallel [(const_int 1)])))
...
(define_insn "kcrsa16_64_le"
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (ss_plus:HI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
				       (parallel [(const_int 0)]))
			(vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
				       (parallel [(const_int 1)])))
	    (ss_minus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			 (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:DSPV2HI
	    (ss_plus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			(vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (ss_minus:HI  (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			  (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "kcrsa16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_insn "vkcrsa16_64_le"
  [(set (match_operand:DSPV4HI 0 "register_operand"         "=r")
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (ss_plus:HI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
				       (parallel [(const_int 0)]))
			(vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
				       (parallel [(const_int 1)])))
...
(define_insn "ukcrsa16_64_le"
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (us_plus:HI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
				       (parallel [(const_int 0)]))
			(vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
				       (parallel [(const_int 1)])))
	    (us_minus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			 (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:DSPV2HI
	    (us_plus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			(vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (us_minus:HI  (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			  (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "ukcrsa16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_insn "vukcrsa16_64_le"
  [(set (match_operand:DSPV4HI 0 "register_operand"         "=r")
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (us_plus:HI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
				       (parallel [(const_int 0)]))
			(vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
				       (parallel [(const_int 1)])))
	...
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (ashiftrt:SI
		(minus:SI
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
						 (parallel [(const_int 0)])))
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
						  (parallel [(const_int 1)]))))
		(const_int 1)))
	    (truncate:HI
	      (ashiftrt:SI
		(plus:SI
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
		(const_int 1))))
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (ashiftrt:SI
		(minus:SI
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)])))
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)]))))
		(const_int 1)))
	    (truncate:HI
	      (ashiftrt:SI
		(plus:SI
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)])))
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))
		(const_int 1))))))]
  "TARGET_DSP && TARGET_64BIT"
  "rcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
	...
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (ashiftrt:SI
		(minus:SI
		  (sign_extend:SI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
						 (parallel [(const_int 0)])))
		  (sign_extend:SI (vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
						  (parallel [(const_int 1)]))))
		(const_int 1)))
	    (truncate:HI
	      (ashiftrt:SI
	...
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (lshiftrt:SI
		(minus:SI
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
						 (parallel [(const_int 0)])))
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
						  (parallel [(const_int 1)]))))
		(const_int 1)))
	    (truncate:HI
	      (lshiftrt:SI
		(plus:SI
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
		(const_int 1))))
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (lshiftrt:SI
		(minus:SI
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)])))
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 3)]))))
		(const_int 1)))
	    (truncate:HI
	      (lshiftrt:SI
		(plus:SI
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)])))
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)]))))
		(const_int 1))))))]
  "TARGET_DSP && TARGET_64BIT"
  "urcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
	...
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (lshiftrt:SI
		(minus:SI
		  (zero_extend:SI (vec_select:HI (match_operand:DSPV4HI 1 "register_operand" " r")
						 (parallel [(const_int 0)])))
		  (zero_extend:SI (vec_select:HI (match_operand:DSPV4HI 2 "register_operand" " r")
						  (parallel [(const_int 1)]))))
		(const_int 1)))
	    (truncate:HI
	      (lshiftrt:SI
...
(define_insn "ksll32"
  [(set (match_operand:DSPV2SI 0 "register_operand"                 "=  r, r")
	(ss_ashift:DSPV2SI (match_operand:DSPV2SI 1 "register_operand" "   r, r")
...
(define_insn "sra32_round"
  [(set (match_operand:DSPV2SI 0 "register_operand"                              "=  r, r")
	(unspec:DSPV2SI [(ashiftrt:DSPV2SI (match_operand:DSPV2SI 1 "register_operand" "   r, r")
				     (match_operand:SI 2   "rimm5u_operand"   " u05, r"))]
		       UNSPEC_DROUND))]
  "TARGET_DSP && TARGET_64BIT"
  "@
...
(define_insn "srl32_round"
  [(set (match_operand:DSPV2SI 0 "register_operand"                              "=  r, r")
	(unspec:DSPV2SI [(lshiftrt:DSPV2SI (match_operand:DSPV2SI 1 "register_operand" "   r, r")
				     (match_operand:SI 2   "rimm5u_operand"   " u05, r"))]
		       UNSPEC_DROUND))]
  "TARGET_DSP && TARGET_64BIT"
  "@
...
(define_insn "<optab>dspv2si3"
  [(set (match_operand:DSPV2SI 0 "register_operand"                 "=  r, r")
	(any_shift:DSPV2SI (match_operand:DSPV2SI 1 "register_operand" "   r, r")
			(match_operand:SI   2  "rimm5u_operand"  " u05, r")))]
  "TARGET_DSP && TARGET_64BIT"
  "@
   <insn>i32\t%0, %1, %2
...
(define_expand "vec_setdspv4qi"
  [(match_operand:DSPV4QI 0 "register_operand" "")
...
(define_expand "insb"
  [(match_operand:DSPV4QI 0 "register_operand" "")
   (match_operand:DSPV4QI 1 "register_operand" "")
...
(define_insn "vec_setv4qi_internal"
  [(set (match_operand:DSPV4QI 0 "register_operand"    "=   r,    r,    r,    r")
	(vec_merge:DSPV4QI
	  (vec_duplicate:DSPV4QI
	    (match_operand:QI 1 "register_operand"  "    r,    r,    r,    r"))
	  (match_operand:DSPV4QI 2 "register_operand"  "    0,    0,    0,    0")
...
(define_insn "vec_setv4qi_internal_vec"
  [(set (match_operand:DSPV4QI 0 "register_operand"       "=  r,   r,   r,   r")
	(vec_merge:DSPV4QI
	  (vec_duplicate:DSPV4QI
	    (vec_select:QI
	      (match_operand:DSPV4QI 1 "register_operand" "   r,   r,   r,   r")
	      (parallel [(const_int 0)])))
	  (match_operand:DSPV4QI 2 "register_operand"     "   0,   0,   0,   0")
	  (match_operand:SI 3 "imm_1_2_4_8_operand"    " M01, M02, M04, M08")))]
  "TARGET_DSP && !TARGET_64BIT"
...
(define_insn "vec_mergev4qi_and_cv0_1"
  [(set (match_operand:DSPV4QI 0 "register_operand"       "=r")
	(vec_merge:DSPV4QI
	  (vec_duplicate:DSPV4QI
	    (vec_select:QI
	      (match_operand:DSPV4QI 1 "register_operand" " r")
	      (parallel [(const_int 0)])))
	  (const_vector:DSPV4QI [
	    (const_int 0)
	    (const_int 0)
	    (const_int 0)
	    (const_int 0)])
...
(define_insn "vec_mergeqi_and_cv0_1"
  [(set (match_operand:DSPV4QI 0 "register_operand"                     "=r")
	(vec_merge:DSPV4QI
	  (vec_duplicate:DSPV4QI (match_operand:QI 1 "register_operand" " r"))
	  (const_vector:DSPV4QI [
	    (const_int 0)
	    (const_int 0)
	    (const_int 0)
...
(define_expand "vec_setdspv8qi"
  [(match_operand:DSPV8QI 0 "register_operand" "")
   (match_operand:QI 1 "register_operand" "")
   (match_operand:SI 2 "immediate_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_expand "insb64"
  [(match_operand:DSPV8QI 0 "register_operand" "")
   (match_operand:DSPV8QI 1 "register_operand" "")
   (match_operand:SI 2 "register_operand" "")
...
(define_insn "vec_setv8qi_internal"
  [(set (match_operand:DSPV8QI 0 "register_operand"    "=r")
	(vec_merge:DSPV8QI
	  (vec_duplicate:DSPV8QI
	    (match_operand:QI 1 "register_operand"  "r"))
	  (match_operand:DSPV8QI 2 "register_operand"  "0")
...
(define_insn "vec_setv8qi_internal_vec"
  [(set (match_operand:DSPV8QI 0 "register_operand"       "=r")
	(vec_merge:DSPV8QI
	  (vec_duplicate:DSPV8QI
	    (vec_select:QI
	      (match_operand:DSPV8QI 1 "register_operand" "r")
	      (parallel [(const_int 0)])))
	  (match_operand:DSPV8QI 2 "register_operand"     "0")
	  (match_operand:SI 3 "pwr_7_operand"    "D07")))]
  "TARGET_DSP && TARGET_64BIT"
...
(define_insn "vec_mergerr"
  [(set (match_operand:DSPV2HI 0 "register_operand"   "=  r,   r")
	(vec_merge:DSPV2HI
	  (vec_duplicate:DSPV2HI
  ...
  "@
   ...
   pkbb16\t%0, %1, %2"
  [(set_attr "type" "dpack")
   (set_attr "mode" "DSPV2HI")])


(define_insn "vec_merge"
  [(set (match_operand:DSPV2HI 0 "register_operand"   "=  r,   r")
	(vec_merge:DSPV2HI
	  (match_operand:DSPV2HI 1 "register_operand" "   r,   r")
	  (match_operand:DSPV2HI 2 "register_operand" "   r,   r")
	  (match_operand:SI 3 "imm_1_2_operand"    " M01, M02")))]
  "TARGET_DSP && !TARGET_64BIT"
{
...
(define_insn "vec_mergerv"
  [(set (match_operand:DSPV2HI 0 "register_operand"               "=   r,    r,    r,    r")
	(vec_merge:DSPV2HI
	  (vec_duplicate:DSPV2HI
	    (match_operand:HI 1 "register_operand"             "    r,    r,    r,    r"))
	  (vec_duplicate:DSPV2HI
	    (vec_select:HI
	      (match_operand:DSPV2HI 2 "register_operand"         "   r,   r,   r,   r")
...
(define_insn "vec_mergevr"
  [(set (match_operand:DSPV2HI 0 "register_operand"                "=  r,   r,   r,   r")
	(vec_merge:DSPV2HI
	  (vec_duplicate:DSPV2HI
	    (vec_select:HI
	      (match_operand:DSPV2HI 1 "register_operand"          "   r,   r,   r,   r")
	       (parallel [(match_operand:SI 4 "imm_0_1_operand" " M00, M01, M00, M01")])))
	  (vec_duplicate:DSPV2HI
...
(define_insn "vec_extractv4qi0"
  [(set (match_operand:QI 0 "register_operand"         "=r,r")
	(vec_select:QI
	  (match_operand:DSPV4QI 1 "nonimmediate_operand" " r,m")
	  (parallel [(const_int 0)])))]
  "TARGET_DSP && !TARGET_64BIT"
  "@
   and\t%0,%1,0xff
...
(define_insn_and_split "vec_extractv2hi0"
  [(set (match_operand:HI 0 "register_operand"         "=r,r")
	(vec_select:HI
	  (match_operand:DSPV2HI 1 "nonimmediate_operand" " r,m")
	  (parallel [(const_int 0)])))]
  "TARGET_DSP && !TARGET_64BIT"
  "@
   nds.bfos\t%0,%1,15,0
...
(define_insn "vec_extractv2hi1"
  [(set (match_operand:HI 0 "register_operand"     "=r")
	(vec_select:HI
	  (match_operand:DSPV2HI 1 "register_operand" " r")
	  (parallel [(const_int 1)])))]
  "TARGET_DSP && !TARGET_64BIT"
  "srai\t%0, %1, 16"
  [(set_attr "type" "arith")
...
(define_insn "vec_pkbb64"
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand" "=r") 0)
	(vec_select:DSPV4HI
	 (vec_concat:DSPV8HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" "r") 0)
			  (subreg:DSPV4HI (match_operand:DI 2 "register_operand" "r") 0))
...
(define_insn "vvec_pkbb64"
  [(set (match_operand:DSPV4HI 0 "register_operand" "=r")
	(vec_select:DSPV4HI
	 (vec_concat:DSPV8HI (match_operand:DSPV4HI 1 "register_operand" "r")
			  (match_operand:DSPV4HI 2 "register_operand" "r"))
	 (parallel [(const_int 0) (const_int 4)
		    (const_int 2) (const_int 6)])))]
  "TARGET_DSP && TARGET_64BIT"
  "pkbb16\t%0, %1, %2"
...
(define_insn "<su>mul16"
  [(set (match_operand:DSPV2SI 0 "register_operand"                             "=r")
	(mult:DSPV2SI (any_extend:DSPV2SI (match_operand:DSPV2HI 1 "register_operand" "%r"))
		   (any_extend:DSPV2SI (match_operand:DSPV2HI 2 "register_operand" " r"))))]
  "TARGET_DSP && !TARGET_64BIT"
  "<su>mul16\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "DSPV2SI")])
	...
	(vec_merge:DSPV2SI
	  (vec_duplicate:DSPV2SI
		...
		(vec_select:HI
	      ...
	      (any_extend:SI
		(vec_select:HI
		  (match_operand:DSPV2HI 2 "register_operand" " r")
		  (parallel [(const_int 1)])))))
	  (vec_duplicate:DSPV2SI
	    (mult:SI
	      (any_extend:SI
...
(define_expand "vec_unpacks_lo_v4qi"
  [(match_operand:DSPV2HI 0 "register_operand" "=r")
   (match_operand:DSPV4QI 1 "register_operand" " r")]
  "TARGET_DSP && !TARGET_64BIT"
{
...
(define_expand "sunpkd810"
  [(match_operand:DSPV2HI 0 "register_operand")
   (match_operand:DSPV4QI 1 "register_operand")]
  "TARGET_DSP && !TARGET_64BIT"
{
...
(define_insn "<zs>unpkd810_imp"
  [(set (match_operand:DSPV2HI 0 "register_operand"                     "=r")
	(vec_merge:DSPV2HI
	  (vec_duplicate:DSPV2HI
	    (any_extend:HI
	      (vec_select:QI
...
(define_insn "<zs>unpkd810_64"
  [(set (match_operand:DSPV4HI 0 "register_operand"                    "=r")
	(vec_select:DSPV4HI
	  (any_extend:DSPV8HI (match_operand:DSPV8QI 1 "register_operand" "r"))
...
(define_expand "vsmbb"
  [(match_operand:SI 0 "register_operand" "")
   (match_operand:DSPV2HI 1 "register_operand" "")
   (match_operand:DSPV2HI 2 "register_operand" "")]
  "TARGET_DSP && !TARGET_64BIT"
{
...
(define_insn "mulhisi3v"
  [(set (match_operand:SI 0 "register_operand"                  "=  r,   r,   r,   r")
	(mult:SI
	  (sign_extend:SI
	     (vec_select:HI
	       (subreg:DSPV2HI (match_operand:SI 1 "register_operand"         "   r,   r,   r,   r") 0)
	       (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")])))
	  (sign_extend:SI (vec_select:HI
	       (subreg:DSPV2HI (match_operand:SI 2 "register_operand"         "   r,   r,   r,   r") 0)
...
(define_expand "vsmbb64"
  [(match_operand:DSPV2SI 0 "register_operand" "")
   (match_operand:DSPV4HI 1 "register_operand" "")
   (match_operand:DSPV4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_insn "mulv2hiv2si3v"
  [(set (subreg:DSPV2SI (match_operand:DI 0 "register_operand" "=r, r, r") 0)
        (mult:DSPV2SI
	 (sign_extend:DSPV2SI
	  (vec_select:DSPV2HI
	   (subreg:DSPV4HI (match_operand:DI 1 "register_operand" "r, r, r") 0)
	   (parallel [(match_operand:SI 3 "imm2u_operand" " M00, M00, M01")
		      (match_operand:SI 4 "imm2u_operand" " M02, M02, M03")])))
	 (sign_extend:DSPV2SI
	  (vec_select:DSPV2HI
	   (subreg:DSPV4HI (match_operand:DI 2 "register_operand" "r, r, r") 0)
...
(define_insn "vmulv2hiv2si3v"
  [(set (match_operand:DSPV2SI 0 "register_operand" "=r, r, r")
        (mult:DSPV2SI
	 (sign_extend:DSPV2SI
	  (vec_select:DSPV2HI
	   (match_operand:DSPV4HI 1 "register_operand" "r, r, r")
	   (parallel [(match_operand:SI 3 "imm2u_operand" " M00, M00, M01")
		      (match_operand:SI 4 "imm2u_operand" " M02, M02, M03")])))
	 (sign_extend:DSPV2SI
	  (vec_select:DSPV2HI
	   (match_operand:DSPV4HI 2 "register_operand" "r, r, r")
	   (parallel [(match_operand:SI 5 "imm2u_operand" " M00, M01, M01")
		      (match_operand:SI 6 "imm2u_operand" " M02, M03, M03")])))))]
  "TARGET_DSP && TARGET_64BIT"
  "@
...
(define_expand "vsmbb32"
  [(match_operand:DI 0 "register_operand" "")
   (match_operand:DSPV2SI 1 "register_operand" "")
   (match_operand:DSPV2SI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_insn "mulsidi3v"
  [(set (match_operand:DI 0 "register_operand"                  "=  r,   r,   r,   r")
	(mult:DI
	  (sign_extend:DI
	     (vec_select:SI
	       (subreg:DSPV2SI (match_operand:DI 1 "register_operand"         "   r,   r,   r,   r") 0)
	       (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")])))
	  (sign_extend:DI (vec_select:SI
	       (subreg:DSPV2SI (match_operand:DI 2 "register_operand"         "   r,   r,   r,   r") 0)
	       (parallel [(match_operand:SI 4 "imm_0_1_operand" " M00, M01, M01, M00")])))))]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_insn "vmulsidi3v"
  [(set (match_operand:DI 0 "register_operand"                  "=  r,   r,   r,   r")
	(mult:DI
	  (sign_extend:DI
	     (vec_select:SI
	       (match_operand:DSPV2SI 1 "register_operand"         "   r,   r,   r,   r")
	       (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")])))
	  (sign_extend:DI (vec_select:SI
	       (match_operand:DSPV2SI 2 "register_operand"         "   r,   r,   r,   r")
	       (parallel [(match_operand:SI 4 "imm_0_1_operand" " M00, M01, M01, M00")])))))]
  "TARGET_DSP && TARGET_64BIT"
{
  const char *pats[] = { "smbb32\t%0, %1, %2",
...
(define_expand "vkmabb"
  [(match_operand:SI 0 "register_operand" "")
   (match_operand:SI 1 "register_operand" "")
   (match_operand:DSPV2HI 2 "register_operand" "")
   (match_operand:DSPV2HI 3 "register_operand" "")]
  "TARGET_DSP && !TARGET_64BIT"
{
...
(define_expand "vkmabb64"
  [(match_operand:DSPV2SI 0 "register_operand" "")
   (match_operand:DSPV2SI 1 "register_operand" "")
   (match_operand:DSPV4HI 2 "register_operand" "")
   (match_operand:DSPV4HI 3 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_insn "kma64_internal"
  [(set (match_operand:DSPV2SI 0 "register_operand"                 "=   r,   r,   r,   r")
	(ss_plus:DSPV2SI
	  (mult:DSPV2SI
	    (sign_extend:DSPV2SI
	      (vec_select:DSPV2HI
		(subreg:DSPV4HI (match_operand:DI 1 "register_operand"         "   r,   r,   r,   r") 0)
	        (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")
			   (match_operand:SI 4 "imm_2_3_operand" " M02, M02, M03, M03")])))
	    (sign_extend:DSPV2SI
	      (vec_select:DSPV2HI
	    (subreg:DSPV4HI (match_operand:DI 2 "register_operand"         "   r,   r,   r,   r") 0)
	        (parallel [(match_operand:SI 5 "imm_0_1_operand" " M00, M01, M01, M00")
			   (match_operand:SI 6 "imm_2_3_operand" " M02, M03, M03, M02")]))))
	  (match_operand:DSPV2SI 7 "register_operand"               "   0,   0,   0,   0")))]
  "TARGET_DSP && TARGET_64BIT"
  "@
  kmabb\t%0, %1, %2
  kmabt\t%0, %1, %2
  ...
  [(set (match_operand:DSPV2SI 0 "register_operand"                 "=   r,   r,   r,   r")
	(ss_plus:DSPV2SI
	  (mult:DSPV2SI
	    (sign_extend:DSPV2SI
	      (vec_select:DSPV2HI
		(match_operand:DSPV4HI 1 "register_operand"         "   r,   r,   r,   r")
	        (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")
			   (match_operand:SI 4 "imm_2_3_operand" " M02, M02, M03, M03")])))
	    (sign_extend:DSPV2SI
	      (vec_select:DSPV2HI
	        (match_operand:DSPV4HI 2 "register_operand"         "   r,   r,   r,   r")
	        (parallel [(match_operand:SI 5 "imm_0_1_operand" " M00, M01, M01, M00")
			   (match_operand:SI 6 "imm_2_3_operand" " M02, M03, M03, M02")]))))
	  (match_operand:DSPV2SI 7 "register_operand"               "   0,   0,   0,   0")))]
  "TARGET_DSP && TARGET_64BIT"
...
(define_expand "vkmabb32"
  [(match_operand:DI 0 "register_operand" "")
   (match_operand:DI 1 "register_operand" "")
   (match_operand:DSPV2SI 2 "register_operand" "")
   (match_operand:DSPV2SI 3 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_insn "smds32"
  [(set (match_operand:DI 0 "register_operand"                         "=r")
	(minus:DI
	  (mult:DI
	    (sign_extend:DI (vec_select:SI
			      (match_operand:DSPV2SI 1 "register_operand" " r")
			      (parallel [(const_int 1)])))
	    (sign_extend:DI (vec_select:SI
			      (match_operand:DSPV2SI 2 "register_operand" " r")
			      (parallel [(const_int 1)]))))
	  (mult:DI
	    (sign_extend:DI (vec_select:SI
			      (match_dup 1)
...
(define_insn "smds64"
  [(set (match_operand:DSPV2SI 0 "register_operand"                      "=r")
	(minus:DSPV2SI
	  (mult:DSPV2SI
	    (sign_extend:DSPV2SI (vec_select:DSPV2HI
				(match_operand:DSPV4HI 1 "register_operand" "r")
				(parallel [(const_int 1) (const_int 3)])))
	    (sign_extend:DSPV2SI (vec_select:DSPV2HI
				(match_operand:DSPV4HI 2 "register_operand" "r")
				(parallel [(const_int 1) (const_int 3)]))))
...
(define_insn "smulsi3_highpart_dsp64"
  [(set (match_operand:SI 0 "register_operand"                       "=r")
	(truncate:SI
	  (lshiftrt:DI
	    (mult:DI
...
(define_insn "smuldspv2si3_highpart"
  [(set (match_operand:DSPV2SI 0 "register_operand" "=r")
	(truncate:DSPV2SI
	  (lshiftrt:DSPV2DI
	    (mult:DSPV2DI (sign_extend:DSPV2DI (match_operand:DSPV2SI 1 "register_operand" " r"))
		       (sign_extend:DSPV2DI (match_operand:DSPV2SI 2 "register_operand" " r")))
	    (const_int 32))))]
  "TARGET_DSP && TARGET_64BIT"
  "smmul\t%0, %1, %2"
  [(set_attr "type" "dmul")
...
(define_insn "smmuldspv2si3_round"
  [(set (match_operand:DSPV2SI 0 "register_operand" "=r")
	(truncate:DSPV2SI
	  (lshiftrt:DSPV2DI
	    (unspec:DSPV2DI [(mult:DSPV2DI
			    (sign_extend:DSPV2DI (match_operand:DSPV2SI 1 "register_operand" " r"))
			    (sign_extend:DSPV2DI (match_operand:DSPV2SI 2 "register_operand" " r")))]
			  UNSPEC_DROUND)
	    (const_int 32))))]
  "TARGET_DSP  && TARGET_64BIT"
...
(define_insn "kmmac_64"
  [(set (match_operand:DSPV2SI 0 "register_operand"                         "=r")
	(ss_plus:DSPV2SI (match_operand:DSPV2SI 1 "register_operand"             " 0")
	  (truncate:DSPV2SI
	    (lshiftrt:DSPV2DI
	      (mult:DSPV2DI
		(sign_extend:DSPV2DI (match_operand:DSPV2SI 2 "register_operand" " r"))
		(sign_extend:DSPV2DI (match_operand:DSPV2SI 3 "register_operand" " r")))
	      (const_int 32)))))]
  "TARGET_DSP && TARGET_64BIT"
  "kmmac\t%0, %2, %3"
  [(set_attr "type" "dmac")])
...
(define_insn "kmmsb_64"
  [(set (match_operand:DSPV2SI 0 "register_operand"                         "=r")
	(ss_minus:DSPV2SI (match_operand:DSPV2SI 1 "register_operand"             " 0")
	  (truncate:DSPV2SI
	    (lshiftrt:DSPV2DI
	      (mult:DSPV2DI
		(sign_extend:DSPV2DI (match_operand:DSPV2SI 2 "register_operand" " r"))
...
(define_insn "kwmmul_64"
  [(set (match_operand:DSPV2SI 0 "register_operand"                       "=r")
	(truncate:DSPV2SI
	  (lshiftrt:DSPV2DI
	    (ss_mult:DSPV2DI
	      (mult:DSPV2DI (sign_extend:DSPV2DI (match_operand:DSPV2SI 1 "register_operand" " r")) (const_int 2))
	      (mult:DSPV2DI (sign_extend:DSPV2DI (match_operand:DSPV2SI 2 "register_operand" " r")) (const_int 2)))
	    (const_int 32))))]
  "TARGET_DSP && TARGET_64BIT"
  "kwmmul\t%0, %1, %2"
  [(set_attr "type" "dmul")])
  ...
  [(set (match_operand:DSPV2SI 0 "register_operand"                       "=r,    r")
	(vec_concat:DSPV2SI
	  (truncate:SI
		...
		(sign_extend:DI
		  (vec_select:SI
		    (match_operand:DSPV2SI 1 "register_operand"           "  r,   r")
		      (parallel [(const_int 0)])))
		(sign_extend:DI
		  (vec_select:HI
		    (match_operand:DSPV4HI 2 "register_operand"           "  r,   r")
		      (parallel [(match_operand:SI 3 "imm_0_1_operand"   "M00, M01")]))))
	      (const_int 16)))
	  (truncate:SI
	    (lshiftrt:DI
...
[(set (match_operand:DSPV2SI 0 "register_operand" "=r, r, r, r")
      (ss_plus:DSPV2SI
	(match_operand:DSPV2SI 5 "register_operand" "0, 0, 0, 0")
	(vec_concat:DSPV2SI
	  (truncate:SI
	    (lshiftrt:DI
	      (mult:DI
...
(define_expand "smalda1"
  [(match_operand:DI 0 "register_even_operand" "")
   (match_operand:DI 1 "register_even_operand" "")
   (match_operand:DSPV2HI 2 "register_operand" " r")
   (match_operand:DSPV2HI 3 "register_operand" " r")]
  "TARGET_DSP && !TARGET_64BIT"
{
	  ...
	  (plus:DI
		...
		(mult:SI
		  (sign_extend:SI (vec_select:HI
				    ...
				    (parallel [(const_int 0)])))
		  (sign_extend:SI (vec_select:HI
				    (match_operand:DSPV4HI 3 "register_operand" " r")
				    (parallel [(const_int 0)]))))
		(mult:SI
	  ...
	  (ss_plus:DI
	    (mult:DI
	      (sign_extend:DI (vec_select:SI
				...
				(parallel [(const_int 1)])))
	      (sign_extend:DI (vec_select:SI
				(match_operand:DSPV2SI 3 "register_operand" " r")
				(parallel [(const_int 1)]))))
	    (mult:DI
	      (sign_extend:DI (vec_select:SI
				(match_dup 2)
...
(define_insn "kmada64"
  [(set (match_operand:DSPV2SI 0 "register_operand"                         "=r")
	(ss_plus:DSPV2SI
	  (match_operand:DSPV2SI 1 "register_operand"                       " 0")
	  (ss_plus:DSPV2SI
	    (mult:DSPV2SI
	      (sign_extend:DSPV2SI (vec_select:DSPV2HI
				(match_operand:DSPV4HI 2 "register_operand" " r")
...
(define_insn "kdmbb16"
  [(set (match_operand:DSPV4HI 0 "register_operand" "=r")
	(unspec:DSPV4HI [(match_operand:DSPV4HI 1 "register_operand" "r")
		      (match_operand:DSPV4HI 2 "register_operand" "r")] UNSPEC_KDMBB16))]
  "TARGET_DSP && TARGET_64BIT"
  "kdmbb16\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "DSPV4HI")])
...
(define_insn "kdmbt16"
  [(set (match_operand:DSPV4HI 0 "register_operand" "=r")
	(unspec:DSPV4HI [(match_operand:DSPV4HI 1 "register_operand" "r")
		      (match_operand:DSPV4HI 2 "register_operand" "r")] UNSPEC_KDMBT16))]
  "TARGET_DSP && TARGET_64BIT"
  "kdmbt16\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "DSPV4HI")])
...
(define_insn "kdmtt16"
  [(set (match_operand:DSPV4HI 0 "register_operand" "=r")
	(unspec:DSPV4HI [(match_operand:DSPV4HI 1 "register_operand" "r")
		      (match_operand:DSPV4HI 2 "register_operand" "r")] UNSPEC_KDMTT16))]
  "TARGET_DSP && TARGET_64BIT"
  "kdmtt16\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "DSPV4HI")])
...
(define_insn "khmbb16"
  [(set (match_operand:DSPV4HI 0 "register_operand" "=r")
	(unspec:DSPV4HI [(match_operand:DSPV4HI 1 "register_operand" "r")
		      (match_operand:DSPV4HI 2 "register_operand" "r")] UNSPEC_KHMBB16))]
  "TARGET_DSP && TARGET_64BIT"
  "khmbb16\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "DSPV4HI")])
...
(define_insn "khmbt16"
  [(set (match_operand:DSPV4HI 0 "register_operand" "=r")
	(unspec:DSPV4HI [(match_operand:DSPV4HI 1 "register_operand" "r")
		      (match_operand:DSPV4HI 2 "register_operand" "r")] UNSPEC_KHMBT16))]
  "TARGET_DSP && TARGET_64BIT"
  "khmbt16\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "DSPV4HI")])
...
(define_insn "khmtt16"
  [(set (match_operand:DSPV4HI 0 "register_operand" "=r")
	(unspec:DSPV4HI [(match_operand:DSPV4HI 1 "register_operand" "r")
		      (match_operand:DSPV4HI 2 "register_operand" "r")] UNSPEC_KHMTT16))]
  "TARGET_DSP && TARGET_64BIT"
  "khmtt16\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "DSPV4HI")])
...
(define_insn "*maddr32_4"
  [(set (match_operand:DI 0 "register_operand"                   "=r")
	(plus:DI (mult:DI (match_operand:DI 1 "register_operand" " r")
			  (match_operand:DI 2 "register_operand" " r"))
              (match_operand:DI 3 "register_operand"          " 0")))]
  "TARGET_DSP && TARGET_64BIT && !reload_completed && operands_nonzero_bits_within_mode_p (operands[1], operands[2], operands[3], SImode)"
  "maddr32\t%0, %1, %2"
  [(set_attr "type"   "dmac")
   (set_attr "mode"   "DI")])

(define_insn "*maddr32_5"
  [(set (match_operand:DI 0 "register_operand"                   "=r")
...
(define_insn "*msubr32_1"
  [(set (match_operand:DI 0 "register_operand"                   "=r")
	(sign_extend:DI (minus:SI (match_operand:SI 3 "register_operand"          " 0")
		 (mult:SI (match_operand:SI 1 "register_operand" " r")
			  (match_operand:SI 2 "register_operand" " r")))))]
  "TARGET_DSP && TARGET_64BIT"
  "msubr32\t%0, %1, %2"
...
(define_insn_and_split "dspbswapsi2"
  [(set (match_operand:SI 0 "register_operand" "=r")
...
(define_expand "vsmaqa"
  [(match_operand:SI 0 "register_operand")
   (match_operand:SI 1 "register_operand")
   (match_operand:DSPV4QI 2 "register_operand")
   (match_operand:DSPV4QI 3 "register_operand")]
  "TARGET_DSP && !TARGET_64BIT"
{
  ...
  [(set (match_operand:SI 0 "register_operand"             "=r")
	(plus:SI (match_operand:SI 1 "register_operand"    " 0")
	  (plus:SI (plus:SI
		...
		(any_extend:HI
		  (vec_select:QI
		    (subreg:DSPV4QI (match_operand:SI 2 "register_operand" "r") 0)
		    (parallel [(const_int 0)])))
		(any_extend:HI
		  (vec_select:QI
		    (subreg:DSPV4QI (match_operand:SI 3 "register_operand" "r") 0)
		    (parallel [(const_int 0)])))))
	    (sign_extend:SI
	      (mult:HI
		(any_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 2) 0) (parallel [(const_int 1)])))
		(any_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 3) 0)(parallel [(const_int 1)]))))))
	  (plus:SI
	    (sign_extend:SI
	      (mult:HI
		(any_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 2) 0)(parallel [(const_int 2)])))
		(any_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 3) 0)(parallel [(const_int 2)])))))
	    (sign_extend:SI
	      (mult:HI
		(any_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 2) 0)(parallel [(const_int 3)])))
		(any_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 3) 0)(parallel [(const_int 3)])))))))))]
  "TARGET_DSP && !TARGET_64BIT"
  "<su>maqa\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "SI")])
  ...
  [(set (match_operand:SI 0 "register_operand"             "=r")
	(plus:SI (match_operand:SI 1 "register_operand"    " 0")
	  (plus:SI (plus:SI
		...
		(any_extend:HI
		  (vec_select:QI
		    (match_operand:DSPV4QI 2 "register_operand" "r")
		    (parallel [(const_int 0)])))
		(any_extend:HI
		  (vec_select:QI
		    (match_operand:DSPV4QI 3 "register_operand" "r")
		    (parallel [(const_int 0)])))))
	    (sign_extend:SI
	      (mult:HI
...
(define_expand "vsmaqa64"
  [(match_operand:DSPV2SI 0 "register_operand")
   (match_operand:DSPV2SI 1 "register_operand")
   (match_operand:DSPV8QI 2 "register_operand")
   (match_operand:DSPV8QI 3 "register_operand")]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_insn "<su>maqav8qi"
  [(set (subreg:DSPV2SI (match_operand:DI 0 "register_operand"             "=r") 0)
	(plus:DSPV2SI (subreg:DSPV2SI (match_operand:DI 1 "register_operand"  "0") 0)
	  (vec_concat:DSPV2SI
	    (plus:SI
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI
		      (vec_select:QI
			(subreg:DSPV8QI (match_operand:DI 2 "register_operand" "r") 0)
			(parallel [(const_int 0)])))
		    (any_extend:HI
		      (vec_select:QI
			(subreg:DSPV8QI (match_operand:DI 3 "register_operand" "r") 0)
			(parallel [(const_int 0)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0) (parallel [(const_int 1)])))
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0) (parallel [(const_int 1)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0) (parallel [(const_int 2)])))
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0) (parallel [(const_int 2)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0) (parallel [(const_int 3)])))
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0) (parallel [(const_int 3)])))))))
	    (plus:SI
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0) (parallel [(const_int 4)])))
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0) (parallel [(const_int 4)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0) (parallel [(const_int 5)])))
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0) (parallel [(const_int 5)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0) (parallel [(const_int 6)])))
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0) (parallel [(const_int 6)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0) (parallel [(const_int 7)])))
		    (any_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0) (parallel [(const_int 7)]))))))))))]
  "TARGET_DSP && TARGET_64BIT"
  "<su>maqa\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "DSPV2SI")])
...
(define_insn "v<su>maqav8qi"
  [(set (match_operand:DSPV2SI 0 "register_operand"             "=r")
	(plus:DSPV2SI (match_operand:DSPV2SI 1 "register_operand"  " 0")
	  (vec_concat:DSPV2SI
	    (plus:SI
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI
		      (vec_select:QI
			(match_operand:DSPV8QI 2 "register_operand" "r")
			(parallel [(const_int 0)])))
		    (any_extend:HI
		      (vec_select:QI
			(match_operand:DSPV8QI 3 "register_operand" "r")
			(parallel [(const_int 0)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (match_dup 2) (parallel [(const_int 1)])))
  ...
  [(set (match_operand:SI 0 "register_operand"             "=r")
	(plus:SI (match_operand:SI 1 "register_operand"    " 0")
	  (plus:SI (plus:SI
	    ...
	    (sign_extend:SI
	      (mult:HI
		(sign_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 2) 0)(parallel [(const_int 1)])))
		(zero_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 3) 0)(parallel [(const_int 1)]))))))

	  (plus:SI
	    (sign_extend:SI
	      (mult:HI
		(sign_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 2) 0)(parallel [(const_int 2)])))
		(zero_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 3) 0)(parallel [(const_int 2)])))))
	    (sign_extend:SI
	      (mult:HI
		(sign_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 2) 0)(parallel [(const_int 3)])))
		(zero_extend:HI (vec_select:QI (subreg:DSPV4QI (match_dup 3) 0)(parallel [(const_int 3)])))))))))]
  "TARGET_DSP && !TARGET_64BIT"
  "smaqa.su\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "SI")])
  ...
  [(set (subreg:DSPV2SI(match_operand:DI 0 "register_operand"             "=r") 0)
	(plus:DSPV2SI (subreg:DSPV2SI (match_operand:DI 1 "register_operand"  " 0") 0)
	  (vec_concat:DSPV2SI
		...
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0)(parallel [(const_int 1)])))
		    (zero_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0)(parallel [(const_int 1)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0)(parallel [(const_int 2)])))
		    (zero_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0)(parallel [(const_int 2)])))))
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0)(parallel [(const_int 3)])))
		    (zero_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0)(parallel [(const_int 3)])))))))
	    (plus:SI
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0)(parallel [(const_int 4)])))
		    (zero_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0)(parallel [(const_int 4)])))))
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0)(parallel [(const_int 5)])))
		    (zero_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0)(parallel [(const_int 5)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0)(parallel [(const_int 6)])))
		    (zero_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0)(parallel [(const_int 6)])))))
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 2) 0)(parallel [(const_int 7)])))
		    (zero_extend:HI (vec_select:QI (subreg:DSPV8QI (match_dup 3) 0)(parallel [(const_int 7)]))))))))))]
  "TARGET_DSP && TARGET_64BIT"
  "smaqa.su\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "DSPV2SI")])
	  ...
	  (vec_concat:DSPV2HI
	    (minus:HI (vec_select:HI (subreg:DSPV4HI (match_operand:DI 1 "register_operand" " r") 0)
		      ...
		      (vec_select:HI (subreg:DSPV4HI (match_operand:DI 2 "register_operand" " r") 0)
				     (parallel [(const_int 0)])))
	    (plus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)]))
		     (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 1)]))))
	  (vec_concat:DSPV2HI
	    (minus:HI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 2)]))
		      (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 2)])))
	    (plus:HI  (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 3)]))
  ...
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
		...
		(plus:SI
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (sign_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 1)]))))
		(const_int 1))))
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (ashiftrt:SI
  ...
  [(set (subreg:DSPV4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:DSPV4HI
	  (vec_concat:DSPV2HI
		...
		(plus:SI
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (zero_extend:SI (vec_select:HI (subreg:DSPV4HI (match_dup 2) 0)(parallel [(const_int 1)]))))
		(const_int 1))))
	  (vec_concat:DSPV2HI
	    (truncate:HI
	      (lshiftrt:SI
...
(define_insn "dsp<bitmanip_optab>si3"
  [(set (match_operand:SI 0 "register_operand" "=r")
