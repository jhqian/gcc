...
#define CRT_BEGIN_SPEC " %{mctor-dtor|coverage:crtbegin.o%s}"
#define CRT_END_SPEC " %{mctor-dtor|coverage:crtend.o%s}"
...
#undef  ENDFILE_SPEC
#define ENDFILE_SPEC CRT_END_SPEC
