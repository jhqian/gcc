(define_automaton "kavalan, kavalan_vector")

(define_cpu_unit "kavalan_pipe0" "kavalan")
(define_cpu_unit "kavalan_pipe1" "kavalan")
(define_cpu_unit "kavalan_vpu_pipe0" "kavalan_vector")
(define_cpu_unit "kavalan_vpu_pipe1" "kavalan_vector")

(define_reservation "kavalan_vpu_pipe" "(kavalan_vpu_pipe0 + kavalan_pipe0 | kavalan_vpu_pipe1 + kavalan_pipe1)")
...
(define_cpu_unit "kavalan_vpu_alu,kavalan_vpu_mac,kavalan_vpu_fmis,kavalan_vpu_permut,
                  kavalan_vpu_div,kavalan_vpu_fdiv,kavalan_vpu_mask,kavalan_vpu_lsu" "kavalan_vector")
...
(define_insn_reservation "kavalan_cmov" 2
  (and (eq_attr "tune" "kavalan")
       (eq_attr "type" "cmov"))
  "kavalan_pipe0+kavalan_alu0 + kavalan_pipe1+kavalan_alu1")
...
(define_insn_reservation "kavalan_imul" 3
  (and (eq_attr "tune" "kavalan")
       (eq_attr "type" "imul"))
...
(define_insn_reservation "kavalan_dsp_mulqi" 1
  (and (eq_attr "tune" "kavalan")
...
(define_insn_reservation "kavalan_dsp_kmar64" 3
  (and (eq_attr "tune" "kavalan")
       (and (eq_attr "type" "dmac")
            (eq_attr "mode" "DI")))
  "kavalan_pipe0 + kavalan_dsp | kavalan_pipe1 + kavalan_dsp")
...
(define_insn_reservation "kavalan_fpu_mac_s" 3
  (and (eq_attr "tune" "kavalan")
       (and (eq_attr "type" "fmadd")
            (eq_attr "mode" "SF")))
  "(kavalan_pipe0 | kavalan_pipe1) + kavalan_fpu_fmac + kavalan_fpu_fmv + kavalan_fpu_fmis")
...
(define_insn_reservation "kavalan_fpu_load" 4
  (and (eq_attr "tune" "kavalan")
       (eq_attr "type" "fpload"))
  "kavalan_pipe0 + kavalan_pipe1 + kavalan_lsu")
...
(define_insn_reservation "kavalan_vpu_mul" 3
  ...
  "kavalan_vpu_pipe + kavalan_vpu_mac")

(define_insn_reservation "kavalan_vpu_div" 36
  (and (eq_attr "tune" "kavalan")
       (eq_attr "type" "vidiv"))
  "kavalan_vpu_pipe + kavalan_vpu_div*35")
...
(define_insn_reservation "kavalan_vpu_fdiv" 38
  ...
  "kavalan_vpu_pipe + kavalan_vpu_fdiv")
...
(define_insn_reservation "kavalan_vpu_fminmax" 2
  ...
  "kavalan_vpu_pipe + kavalan_vpu_fmis")
...
(define_insn_reservation "kavalan_vpu_malu" 3
  (and (eq_attr "tune" "kavalan")
       (eq_attr "type" "vmalu"))
  "kavalan_vpu_pipe + kavalan_vpu_mask")
...
(define_insn_reservation "kavalan_vpu_compress" 4
  (and (eq_attr "tune" "kavalan")
       (eq_attr "type" "vcompress"))
  "kavalan_vpu_pipe + kavalan_vpu_permut")

(define_bypass 4
  "kavalan_load_wd, kavalan_load_bh"
  "kavalan_dsp_alu, kavalan_dsp_alu64, kavalan_dsp_alu_round,\
   kavalan_dsp_cmp, kavalan_dsp_clip, kavalan_dsp_insb, kavalan_dsp_pack,\
   kavalan_dsp_bpick, kavalan_dsp_wext, kavalan_dsp_mul, kavalan_dsp_mac")

(define_bypass 1
  "kavalan_fpu_alu_s, kavalan_fpu_mul_s, kavalan_fpu_mac_s"
  "kavalan_load_wd, kavalan_load_bh, kavalan_store,\
   kavalan_fpu_load, kavalan_fpu_store")

(define_bypass 2
  "kavalan_fpu_alu_d, kavalan_fpu_mul_d, kavalan_fpu_mac_d"
  "kavalan_load_wd, kavalan_load_bh, kavalan_store,\
   kavalan_fpu_load, kavalan_fpu_store")

(define_bypass 1
  "kavalan_fpu_cmp, kavalan_fpu_cvt"
  "kavalan_load_wd, kavalan_load_bh, kavalan_store,\
   kavalan_fpu_load, kavalan_fpu_store, kavalan_alu_insn_s,\
   kavalan_alu_insn_l, kavalan_xfer")
