...
{
  return __riscv_nds_vqmacc_vv_i32mf2_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i32mf2_m (vbool64_t mask, vint32mf2_t vd, int8_t rs1,
			     vint8mf8_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i32mf2_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i32m1_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i32m1_m (vbool32_t mask, vint32m1_t vd, int8_t rs1,
			    vint8mf4_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i32m1_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i32m2_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i32m2_m (vbool16_t mask, vint32m2_t vd, int8_t rs1,
			    vint8mf2_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i32m2_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i32m4_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i32m4_m (vbool8_t mask, vint32m4_t vd, int8_t rs1,
			    vint8m1_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i32m4_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i32m8_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i32m8_m (vbool4_t mask, vint32m8_t vd, int8_t rs1,
			    vint8m2_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i32m8_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i64m1_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i64m1_m (vbool64_t mask, vint64m1_t vd, int16_t rs1,
			    vint16mf4_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i64m1_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i64m2_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i64m2_m (vbool32_t mask, vint64m2_t vd, int16_t rs1,
			    vint16mf2_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i64m2_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i64m4_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i64m4_m (vbool16_t mask, vint64m4_t vd, int16_t rs1,
			    vint16m1_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i64m4_m (mask, vd, rs1, vs2, vl);
}
...
{
  return __riscv_nds_vqmacc_vv_i64m8_m (mask, vd, vs1, vs2, vl);
}
...
test_nds_vqmacc_vx_i64m8_m (vbool8_t mask, vint64m8_t vd, int16_t rs1,
			    vint16m2_t vs2, size_t vl)
{
  return __riscv_nds_vqmacc_vx_i64m8_m (mask, vd, rs1, vs2, vl);
}
