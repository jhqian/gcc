...
test_vd4dotu_vv_u32mf2 (vuint32mf2_t vd, vuint8mf2_t vs1, vuint8mf2_t vs2,
			size_t vl)
{
  return __riscv_vd4dotu_vv_u32mf2(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u32m1 (vuint32m1_t vd, vuint8m1_t vs1, vuint8m1_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u32m1(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u32m2 (vuint32m2_t vd, vuint8m2_t vs1, vuint8m2_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u32m2(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u32m4 (vuint32m4_t vd, vuint8m4_t vs1, vuint8m4_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u32m4(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u32m8 (vuint32m8_t vd, vuint8m8_t vs1, vuint8m8_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u32m8(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u64m1 (vuint64m1_t vd, vuint16m1_t vs1, vuint16m1_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u64m1(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u64m2 (vuint64m2_t vd, vuint16m2_t vs1, vuint16m2_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u64m2(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u64m4 (vuint64m4_t vd, vuint16m4_t vs1, vuint16m4_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u64m4(vd, vs1, vs2, vl);
}
...
test_vd4dotu_vv_u64m8 (vuint64m8_t vd, vuint16m8_t vs1, vuint16m8_t vs2,
		       size_t vl)
{
  return __riscv_vd4dotu_vv_u64m8(vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u32mf2_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u32m1_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u32m2_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u32m4_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u32m8_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u64m1_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u64m2_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u64m4_m (vm, vd, vs1, vs2, vl);
}
...
{
  return __riscv_vd4dotu_vv_u64m8_m (vm, vd, vs1, vs2, vl);
}
