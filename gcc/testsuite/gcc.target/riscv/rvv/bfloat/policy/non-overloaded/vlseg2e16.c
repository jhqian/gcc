...
{
  return __riscv_vlseg2e16_v_bf16mf4x2_tu (maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16mf2x2_tu (vbfloat16mf2x2_t maskedoff_tuple,
			       const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16mf2x2_tu (maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m1x2_tu (vbfloat16m1x2_t maskedoff_tuple,
			      const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m1x2_tu (maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m2x2_tu (vbfloat16m2x2_t maskedoff_tuple,
			      const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m2x2_tu (maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m4x2_tu (vbfloat16m4x2_t maskedoff_tuple,
			      const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m4x2_tu (maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16mf4x2_tum (vbool64_t mask,
				...
				const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16mf4x2_tum (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16mf2x2_tum (vbool32_t mask,
				...
				const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16mf2x2_tum (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m1x2_tum (vbool16_t mask, vbfloat16m1x2_t maskedoff_tuple,
			       const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m1x2_tum (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m2x2_tum (vbool8_t mask, vbfloat16m2x2_t maskedoff_tuple,
			       const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m2x2_tum (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m4x2_tum (vbool4_t mask, vbfloat16m4x2_t maskedoff_tuple,
			       const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m4x2_tum (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16mf4x2_tumu (vbool64_t mask,
				 ...
				 const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16mf4x2_tumu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16mf2x2_tumu (vbool32_t mask,
				 ...
				 const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16mf2x2_tumu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m1x2_tumu (vbool16_t mask, vbfloat16m1x2_t maskedoff_tuple,
				const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m1x2_tumu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m2x2_tumu (vbool8_t mask, vbfloat16m2x2_t maskedoff_tuple,
				const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m2x2_tumu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m4x2_tumu (vbool4_t mask, vbfloat16m4x2_t maskedoff_tuple,
				const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m4x2_tumu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16mf4x2_mu (vbool64_t mask, vbfloat16mf4x2_t maskedoff_tuple,
			       const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16mf4x2_mu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16mf2x2_mu (vbool32_t mask, vbfloat16mf2x2_t maskedoff_tuple,
			       const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16mf2x2_mu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m1x2_mu (vbool16_t mask, vbfloat16m1x2_t maskedoff_tuple,
			      const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m1x2_mu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m2x2_mu (vbool8_t mask, vbfloat16m2x2_t maskedoff_tuple,
			      const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m2x2_mu (mask, maskedoff_tuple, base, vl);
}
...
test_vlseg2e16_v_bf16m4x2_mu (vbool4_t mask, vbfloat16m4x2_t maskedoff_tuple,
			      const __bf16 *base, size_t vl)
{
  return __riscv_vlseg2e16_v_bf16m4x2_mu (mask, maskedoff_tuple, base, vl);
}
