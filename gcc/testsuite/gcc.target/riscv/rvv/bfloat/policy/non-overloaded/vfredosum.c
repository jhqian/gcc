...
{
  return __riscv_vfredosum_vs_bf16mf4_bf16m1_tu (maskedoff, vector, scalar, vl);
}
...
test_vfredosum_vs_bf16mf2_bf16m1_tu (vbfloat16m1_t maskedoff,
				     ...
				     vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16mf2_bf16m1_tu (maskedoff, vector, scalar, vl);
}
...
test_vfredosum_vs_bf16m1_bf16m1_tu (vbfloat16m1_t maskedoff,
				    ...
				    size_t vl)
{
  return __riscv_vfredosum_vs_bf16m1_bf16m1_tu (maskedoff, vector, scalar, vl);
}
...
test_vfredosum_vs_bf16m2_bf16m1_tu (vbfloat16m1_t maskedoff,
				    ...
				    size_t vl)
{
  return __riscv_vfredosum_vs_bf16m2_bf16m1_tu (maskedoff, vector, scalar, vl);
}
...
test_vfredosum_vs_bf16m4_bf16m1_tu (vbfloat16m1_t maskedoff,
				    ...
				    size_t vl)
{
  return __riscv_vfredosum_vs_bf16m4_bf16m1_tu (maskedoff, vector, scalar, vl);
}
...
test_vfredosum_vs_bf16m8_bf16m1_tu (vbfloat16m1_t maskedoff,
				    ...
				    size_t vl)
{
  return __riscv_vfredosum_vs_bf16m8_bf16m1_tu (maskedoff, vector, scalar, vl);
}
...
test_vfredosum_vs_bf16mf4_bf16m1_tum (vbool64_t mask, vbfloat16m1_t maskedoff,
				      ...
				      vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16mf4_bf16m1_tum (mask, maskedoff, vector,
						  scalar, vl);
}
...
test_vfredosum_vs_bf16mf2_bf16m1_tum (vbool32_t mask, vbfloat16m1_t maskedoff,
				      ...
				      vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16mf2_bf16m1_tum (mask, maskedoff, vector,
						  scalar, vl);
}
...
test_vfredosum_vs_bf16m1_bf16m1_tum (vbool16_t mask, vbfloat16m1_t maskedoff,
				     ...
				     size_t vl)
{
  return __riscv_vfredosum_vs_bf16m1_bf16m1_tum (mask, maskedoff, vector,
						 scalar, vl);
}
...
test_vfredosum_vs_bf16m2_bf16m1_tum (vbool8_t mask, vbfloat16m1_t maskedoff,
				     ...
				     size_t vl)
{
  return __riscv_vfredosum_vs_bf16m2_bf16m1_tum (mask, maskedoff, vector,
						 scalar, vl);
}
...
test_vfredosum_vs_bf16m4_bf16m1_tum (vbool4_t mask, vbfloat16m1_t maskedoff,
				     ...
				     size_t vl)
{
  return __riscv_vfredosum_vs_bf16m4_bf16m1_tum (mask, maskedoff, vector,
						 scalar, vl);
}
...
test_vfredosum_vs_bf16m8_bf16m1_tum (vbool2_t mask, vbfloat16m1_t maskedoff,
				     ...
				     size_t vl)
{
  return __riscv_vfredosum_vs_bf16m8_bf16m1_tum (mask, maskedoff, vector,
						 scalar, vl);
}
...
test_vfredosum_vs_bf16mf4_bf16m1_rm_tu (vbfloat16m1_t maskedoff,
					...
					vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16mf4_bf16m1_rm_tu (maskedoff, vector, scalar,
						    __RISCV_FRM_RNE, vl);
}
...
test_vfredosum_vs_bf16mf2_bf16m1_rm_tu (vbfloat16m1_t maskedoff,
					...
					vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16mf2_bf16m1_rm_tu (maskedoff, vector, scalar,
						    __RISCV_FRM_RNE, vl);
}
...
test_vfredosum_vs_bf16m1_bf16m1_rm_tu (vbfloat16m1_t maskedoff,
				       ...
				       vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m1_bf16m1_rm_tu (maskedoff, vector, scalar,
						   __RISCV_FRM_RNE, vl);
}
...
test_vfredosum_vs_bf16m2_bf16m1_rm_tu (vbfloat16m1_t maskedoff,
				       ...
				       vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m2_bf16m1_rm_tu (maskedoff, vector, scalar,
						   __RISCV_FRM_RNE, vl);
}
...
test_vfredosum_vs_bf16m4_bf16m1_rm_tu (vbfloat16m1_t maskedoff,
				       ...
				       vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m4_bf16m1_rm_tu (maskedoff, vector, scalar,
						   __RISCV_FRM_RNE, vl);
}
...
test_vfredosum_vs_bf16m8_bf16m1_rm_tu (vbfloat16m1_t maskedoff,
				       ...
				       vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m8_bf16m1_rm_tu (maskedoff, vector, scalar,
						   __RISCV_FRM_RNE, vl);
}
...
test_vfredosum_vs_bf16mf4_bf16m1_rm_tum (vbool64_t mask,
					 ...
					 vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16mf4_bf16m1_rm_tum (mask, maskedoff, vector,
...
test_vfredosum_vs_bf16mf2_bf16m1_rm_tum (vbool32_t mask,
					 ...
					 vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16mf2_bf16m1_rm_tum (mask, maskedoff, vector,
						     scalar, __RISCV_FRM_RNE,
						     vl);
}
...
test_vfredosum_vs_bf16m1_bf16m1_rm_tum (vbool16_t mask, vbfloat16m1_t maskedoff,
					...
					vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m1_bf16m1_rm_tum (mask, maskedoff, vector,
						    scalar, __RISCV_FRM_RNE,
						    vl);
}
...
test_vfredosum_vs_bf16m2_bf16m1_rm_tum (vbool8_t mask, vbfloat16m1_t maskedoff,
					...
					vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m2_bf16m1_rm_tum (mask, maskedoff, vector,
						    scalar, __RISCV_FRM_RNE,
						    vl);
}
...
test_vfredosum_vs_bf16m4_bf16m1_rm_tum (vbool4_t mask, vbfloat16m1_t maskedoff,
					...
					vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m4_bf16m1_rm_tum (mask, maskedoff, vector,
						    scalar, __RISCV_FRM_RNE,
						    vl);
}
...
test_vfredosum_vs_bf16m8_bf16m1_rm_tum (vbool2_t mask, vbfloat16m1_t maskedoff,
					...
					vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredosum_vs_bf16m8_bf16m1_rm_tum (mask, maskedoff, vector,
						    scalar, __RISCV_FRM_RNE,
						    vl);
}
