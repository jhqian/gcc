...
{
  return __riscv_vlseg3e16ff_v_bf16mf4x3_tu (maskedoff_tuple, base, new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16mf2x3_tu (vbfloat16mf2x3_t maskedoff_tuple,
				 const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16mf2x3_tu (maskedoff_tuple, base, new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16m1x3_tu (vbfloat16m1x3_t maskedoff_tuple,
				const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m1x3_tu (maskedoff_tuple, base, new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16m2x3_tu (vbfloat16m2x3_t maskedoff_tuple,
				const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m2x3_tu (maskedoff_tuple, base, new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16mf4x3_tum (vbool64_t mask,
				  ...
				  const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16mf4x3_tum (mask, maskedoff_tuple, base,
					      new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16mf2x3_tum (vbool32_t mask,
				  ...
				  const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16mf2x3_tum (mask, maskedoff_tuple, base,
					      new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16m1x3_tum (vbool16_t mask,
				 ...
				 const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m1x3_tum (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16m2x3_tum (vbool8_t mask, vbfloat16m2x3_t maskedoff_tuple,
				 const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m2x3_tum (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_i16mf4x3_tum (vbool64_t mask, vint16mf4x3_t maskedoff_tuple,
				 const int16_t *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_i16mf4x3_tum (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_i16mf2x3_tum (vbool32_t mask, vint16mf2x3_t maskedoff_tuple,
				 const int16_t *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_i16mf2x3_tum (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_u16mf4x3_tum (vbool64_t mask, vuint16mf4x3_t maskedoff_tuple,
				 ...
				 size_t vl)
{
  return __riscv_vlseg3e16ff_v_u16mf4x3_tum (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_u16mf2x3_tum (vbool32_t mask, vuint16mf2x3_t maskedoff_tuple,
				 ...
				 size_t vl)
{
  return __riscv_vlseg3e16ff_v_u16mf2x3_tum (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16mf4x3_tumu (vbool64_t mask,
				   ...
				   size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16mf4x3_tumu (mask, maskedoff_tuple, base,
					       new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16mf2x3_tumu (vbool32_t mask,
				   ...
				   size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16mf2x3_tumu (mask, maskedoff_tuple, base,
					       new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16m1x3_tumu (vbool16_t mask,
				  ...
				  const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m1x3_tumu (mask, maskedoff_tuple, base,
					      new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16m2x3_tumu (vbool8_t mask,
				  ...
				  const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m2x3_tumu (mask, maskedoff_tuple, base,
					      new_vl, vl);
}
...
test_vlseg3e16ff_v_i16m1x3_tumu (vbool16_t mask, vint16m1x3_t maskedoff_tuple,
				 const int16_t *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_i16m1x3_tumu (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_i16m2x3_tumu (vbool8_t mask, vint16m2x3_t maskedoff_tuple,
				 const int16_t *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_i16m2x3_tumu (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_u16m1x3_tumu (vbool16_t mask, vuint16m1x3_t maskedoff_tuple,
				 ...
				 size_t vl)
{
  return __riscv_vlseg3e16ff_v_u16m1x3_tumu (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_u16m2x3_tumu (vbool8_t mask, vuint16m2x3_t maskedoff_tuple,
				 ...
				 size_t vl)
{
  return __riscv_vlseg3e16ff_v_u16m2x3_tumu (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16mf4x3_mu (vbool64_t mask,
				 ...
				 const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16mf4x3_mu (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16mf2x3_mu (vbool32_t mask,
				 ...
				 const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16mf2x3_mu (mask, maskedoff_tuple, base,
					     new_vl, vl);
}
...
test_vlseg3e16ff_v_bf16m1x3_mu (vbool16_t mask, vbfloat16m1x3_t maskedoff_tuple,
				const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m1x3_mu (mask, maskedoff_tuple, base, new_vl,
					    vl);
}
...
test_vlseg3e16ff_v_bf16m2x3_mu (vbool8_t mask, vbfloat16m2x3_t maskedoff_tuple,
				const __bf16 *base, size_t *new_vl, size_t vl)
{
  return __riscv_vlseg3e16ff_v_bf16m2x3_mu (mask, maskedoff_tuple, base, new_vl,
					    vl);
}
