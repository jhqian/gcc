...
{
  return __riscv_vlmul_trunc_bf16mf4 (op1);
}
...
{
  return __riscv_vlmul_trunc_bf16mf2 (op1);
}
...
{
  return __riscv_vlmul_trunc_bf16m1 (op1);
}
...
{
  return __riscv_vlmul_trunc_bf16m2 (op1);
}
...
{
  return __riscv_vlmul_trunc_bf16m4 (op1);
}
