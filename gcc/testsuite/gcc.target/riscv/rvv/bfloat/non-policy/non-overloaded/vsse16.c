...
test_vsse16_v_bf16mf4 (__bf16 *base, ptrdiff_t bstride, vbfloat16mf4_t value,
		       size_t vl)
{
  return __riscv_vsse16_v_bf16mf4 (base, bstride, value, vl);
}
...
test_vsse16_v_bf16mf2 (__bf16 *base, ptrdiff_t bstride, vbfloat16mf2_t value,
		       size_t vl)
{
  return __riscv_vsse16_v_bf16mf2 (base, bstride, value, vl);
}
...
test_vsse16_v_bf16m1 (__bf16 *base, ptrdiff_t bstride, vbfloat16m1_t value,
		      size_t vl)
{
  return __riscv_vsse16_v_bf16m1 (base, bstride, value, vl);
}
...
test_vsse16_v_bf16m2 (__bf16 *base, ptrdiff_t bstride, vbfloat16m2_t value,
		      size_t vl)
{
  return __riscv_vsse16_v_bf16m2 (base, bstride, value, vl);
}
...
test_vsse16_v_bf16m4 (__bf16 *base, ptrdiff_t bstride, vbfloat16m4_t value,
		      size_t vl)
{
  return __riscv_vsse16_v_bf16m4 (base, bstride, value, vl);
}
...
test_vsse16_v_bf16m8 (__bf16 *base, ptrdiff_t bstride, vbfloat16m8_t value,
		      size_t vl)
{
  return __riscv_vsse16_v_bf16m8 (base, bstride, value, vl);
}
...
{
  return __riscv_vsse16_v_bf16mf4_m (mask, base, bstride, value, vl);
}
...
{
  return __riscv_vsse16_v_bf16mf2_m (mask, base, bstride, value, vl);
}
...
{
  return __riscv_vsse16_v_bf16m1_m (mask, base, bstride, value, vl);
}
...
{
  return __riscv_vsse16_v_bf16m2_m (mask, base, bstride, value, vl);
}
...
{
  return __riscv_vsse16_v_bf16m4_m (mask, base, bstride, value, vl);
}
...
{
  return __riscv_vsse16_v_bf16m8_m (mask, base, bstride, value, vl);
}
