...
vbfloat16mf4_t
test_vlmul_trunc_v_bf16mf2_bf16mf4 (vbfloat16mf2_t op1)
{
  return __riscv_vlmul_trunc_v_bf16mf2_bf16mf4 (op1);
}

vbfloat16mf4_t
test_vlmul_trunc_v_bf16m1_bf16mf4 (vbfloat16m1_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m1_bf16mf4 (op1);
}

vbfloat16mf2_t
test_vlmul_trunc_v_bf16m1_bf16mf2 (vbfloat16m1_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m1_bf16mf2 (op1);
}

vbfloat16mf4_t
test_vlmul_trunc_v_bf16m2_bf16mf4 (vbfloat16m2_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m2_bf16mf4 (op1);
}

vbfloat16mf2_t
test_vlmul_trunc_v_bf16m2_bf16mf2 (vbfloat16m2_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m2_bf16mf2 (op1);
}

vbfloat16m1_t
test_vlmul_trunc_v_bf16m2_bf16m1 (vbfloat16m2_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m2_bf16m1 (op1);
}

vbfloat16mf4_t
test_vlmul_trunc_v_bf16m4_bf16mf4 (vbfloat16m4_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m4_bf16mf4 (op1);
}

vbfloat16mf2_t
test_vlmul_trunc_v_bf16m4_bf16mf2 (vbfloat16m4_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m4_bf16mf2 (op1);
}

vbfloat16m1_t
test_vlmul_trunc_v_bf16m4_bf16m1 (vbfloat16m4_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m4_bf16m1 (op1);
}

vbfloat16m2_t
test_vlmul_trunc_v_bf16m4_bf16m2 (vbfloat16m4_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m4_bf16m2 (op1);
}

vbfloat16mf4_t
test_vlmul_trunc_v_bf16m8_bf16mf4 (vbfloat16m8_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m8_bf16mf4 (op1);
}

vbfloat16mf2_t
test_vlmul_trunc_v_bf16m8_bf16mf2 (vbfloat16m8_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m8_bf16mf2 (op1);
}

vbfloat16m1_t
test_vlmul_trunc_v_bf16m8_bf16m1 (vbfloat16m8_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m8_bf16m1 (op1);
}

vbfloat16m2_t
test_vlmul_trunc_v_bf16m8_bf16m2 (vbfloat16m8_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m8_bf16m2 (op1);
}

vbfloat16m4_t
test_vlmul_trunc_v_bf16m8_bf16m4 (vbfloat16m8_t op1)
{
  return __riscv_vlmul_trunc_v_bf16m8_bf16m4 (op1);
}
