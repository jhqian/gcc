...
{
  return __riscv_vsseg7e16_v_bf16mf4x7 (base, v_tuple, vl);
}

void
test_vsseg7e16_v_bf16mf2x7 (__bf16 *base, vbfloat16mf2x7_t v_tuple, size_t vl)
{
  return __riscv_vsseg7e16_v_bf16mf2x7 (base, v_tuple, vl);
}

void
test_vsseg7e16_v_bf16m1x7 (__bf16 *base, vbfloat16m1x7_t v_tuple, size_t vl)
{
  return __riscv_vsseg7e16_v_bf16m1x7 (base, v_tuple, vl);
}
...
{
  return __riscv_vsseg7e16_v_bf16mf4x7_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg7e16_v_bf16mf2x7_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg7e16_v_bf16m1x7_m (mask, base, v_tuple, vl);
}
