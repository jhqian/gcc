...
{
  return __riscv_vsseg4e16_v_bf16mf4x4_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg4e16_v_bf16mf2x4_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg4e16_v_bf16m1x4_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg4e16_v_bf16m2x4_m (mask, base, v_tuple, vl);
}
