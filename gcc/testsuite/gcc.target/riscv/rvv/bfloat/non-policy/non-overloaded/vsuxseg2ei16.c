...
{
  return __riscv_vsuxseg2ei16_v_bf16mf4x2 (base, bindex, v_tuple, vl);
}
...
{
  return __riscv_vsuxseg2ei16_v_bf16mf2x2 (base, bindex, v_tuple, vl);
}
...
{
  return __riscv_vsuxseg2ei16_v_bf16m1x2 (base, bindex, v_tuple, vl);
}
...
{
  return __riscv_vsuxseg2ei16_v_bf16m2x2 (base, bindex, v_tuple, vl);
}
...
{
  return __riscv_vsuxseg2ei16_v_bf16m4x2 (base, bindex, v_tuple, vl);
}
...
test_vsuxseg2ei16_v_bf16mf4x2_m (vbool64_t mask, __bf16 *base,
				 ...
				 size_t vl)
{
  return __riscv_vsuxseg2ei16_v_bf16mf4x2_m (mask, base, bindex, v_tuple, vl);
}
...
test_vsuxseg2ei16_v_bf16mf2x2_m (vbool32_t mask, __bf16 *base,
				 ...
				 size_t vl)
{
  return __riscv_vsuxseg2ei16_v_bf16mf2x2_m (mask, base, bindex, v_tuple, vl);
}
...
test_vsuxseg2ei16_v_bf16m1x2_m (vbool16_t mask, __bf16 *base,
				...
				size_t vl)
{
  return __riscv_vsuxseg2ei16_v_bf16m1x2_m (mask, base, bindex, v_tuple, vl);
}
...
test_vsuxseg2ei16_v_bf16m2x2_m (vbool8_t mask, __bf16 *base, vuint16m2_t bindex,
				vbfloat16m2x2_t v_tuple, size_t vl)
{
  return __riscv_vsuxseg2ei16_v_bf16m2x2_m (mask, base, bindex, v_tuple, vl);
}
...
test_vsuxseg2ei16_v_bf16m4x2_m (vbool4_t mask, __bf16 *base, vuint16m4_t bindex,
				vbfloat16m4x2_t v_tuple, size_t vl)
{
  return __riscv_vsuxseg2ei16_v_bf16m4x2_m (mask, base, bindex, v_tuple, vl);
}
