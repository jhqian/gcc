...
{
  return __riscv_vsseg2e16_v_bf16mf4x2_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg2e16_v_bf16mf2x2_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg2e16_v_bf16m1x2_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg2e16_v_bf16m2x2_m (mask, base, v_tuple, vl);
}
...
{
  return __riscv_vsseg2e16_v_bf16m4x2_m (mask, base, v_tuple, vl);
}
