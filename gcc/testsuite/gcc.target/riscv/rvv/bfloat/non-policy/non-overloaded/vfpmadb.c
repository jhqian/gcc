...
test_vfpmadb_vf_bf16mf4_m (vbool64_t mask, vbfloat16mf4_t op1, float op2,
			   size_t vl)
{
  return __riscv_vfpmadb_vf_bf16mf4_m (mask, op1, op2, vl);
}
...
test_vfpmadb_vf_bf16mf2_m (vbool32_t mask, vbfloat16mf2_t op1, float op2,
			   size_t vl)
{
  return __riscv_vfpmadb_vf_bf16mf2_m (mask, op1, op2, vl);
}
...
test_vfpmadb_vf_bf16m1_m (vbool16_t mask, vbfloat16m1_t op1, float op2,
			  size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m1_m (mask, op1, op2, vl);
}
...
test_vfpmadb_vf_bf16m2_m (vbool8_t mask, vbfloat16m2_t op1, float op2,
			  size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m2_m (mask, op1, op2, vl);
}
...
test_vfpmadb_vf_bf16m4_m (vbool4_t mask, vbfloat16m4_t op1, float op2,
			  size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m4_m (mask, op1, op2, vl);
}
...
test_vfpmadb_vf_bf16m8_m (vbool2_t mask, vbfloat16m8_t op1, float op2,
			  size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m8_m (mask, op1, op2, vl);
}

vbfloat16mf4_t
test_vfpmadb_vf_bf16mf4_rm (vbfloat16mf4_t op1, float op2, size_t vl)
{
  return __riscv_vfpmadb_vf_bf16mf4_rm (op1, op2, __RISCV_FRM_RNE, vl);
}

vbfloat16mf2_t
test_vfpmadb_vf_bf16mf2_rm (vbfloat16mf2_t op1, float op2, size_t vl)
{
  return __riscv_vfpmadb_vf_bf16mf2_rm (op1, op2, __RISCV_FRM_RNE, vl);
}

vbfloat16m1_t
test_vfpmadb_vf_bf16m1_rm (vbfloat16m1_t op1, float op2, size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m1_rm (op1, op2, __RISCV_FRM_RNE, vl);
}

vbfloat16m2_t
test_vfpmadb_vf_bf16m2_rm (vbfloat16m2_t op1, float op2, size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m2_rm (op1, op2, __RISCV_FRM_RNE, vl);
}

vbfloat16m4_t
test_vfpmadb_vf_bf16m4_rm (vbfloat16m4_t op1, float op2, size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m4_rm (op1, op2, __RISCV_FRM_RNE, vl);
}

vbfloat16m8_t
test_vfpmadb_vf_bf16m8_rm (vbfloat16m8_t op1, float op2, size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m8_rm (op1, op2, __RISCV_FRM_RNE, vl);
}
...
test_vfpmadb_vf_bf16mf4_rm_m (vbool64_t mask, vbfloat16mf4_t op1, float op2,
			      size_t vl)
{
  return __riscv_vfpmadb_vf_bf16mf4_rm_m (mask, op1, op2, __RISCV_FRM_RNE, vl);
}
...
test_vfpmadb_vf_bf16mf2_rm_m (vbool32_t mask, vbfloat16mf2_t op1, float op2,
			      size_t vl)
{
  return __riscv_vfpmadb_vf_bf16mf2_rm_m (mask, op1, op2, __RISCV_FRM_RNE, vl);
}
...
test_vfpmadb_vf_bf16m1_rm_m (vbool16_t mask, vbfloat16m1_t op1, float op2,
			     size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m1_rm_m (mask, op1, op2, __RISCV_FRM_RNE, vl);
}
...
test_vfpmadb_vf_bf16m2_rm_m (vbool8_t mask, vbfloat16m2_t op1, float op2,
			     size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m2_rm_m (mask, op1, op2, __RISCV_FRM_RNE, vl);
}
...
test_vfpmadb_vf_bf16m4_rm_m (vbool4_t mask, vbfloat16m4_t op1, float op2,
			     size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m4_rm_m (mask, op1, op2, __RISCV_FRM_RNE, vl);
}
...
test_vfpmadb_vf_bf16m8_rm_m (vbool2_t mask, vbfloat16m8_t op1, float op2,
			     size_t vl)
{
  return __riscv_vfpmadb_vf_bf16m8_rm_m (mask, op1, op2, __RISCV_FRM_RNE, vl);
}
