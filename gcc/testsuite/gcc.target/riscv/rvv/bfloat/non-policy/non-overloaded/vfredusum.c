...
test_vfredusum_vs_bf16mf4_bf16m1 (vbfloat16mf4_t vector, vbfloat16m1_t scalar,
				  size_t vl)
{
  return __riscv_vfredusum_vs_bf16mf4_bf16m1 (vector, scalar, vl);
}
...
test_vfredusum_vs_bf16mf2_bf16m1 (vbfloat16mf2_t vector, vbfloat16m1_t scalar,
				  size_t vl)
{
  return __riscv_vfredusum_vs_bf16mf2_bf16m1 (vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m1_bf16m1 (vbfloat16m1_t vector, vbfloat16m1_t scalar,
				 size_t vl)
{
  return __riscv_vfredusum_vs_bf16m1_bf16m1 (vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m2_bf16m1 (vbfloat16m2_t vector, vbfloat16m1_t scalar,
				 size_t vl)
{
  return __riscv_vfredusum_vs_bf16m2_bf16m1 (vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m4_bf16m1 (vbfloat16m4_t vector, vbfloat16m1_t scalar,
				 size_t vl)
{
  return __riscv_vfredusum_vs_bf16m4_bf16m1 (vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m8_bf16m1 (vbfloat16m8_t vector, vbfloat16m1_t scalar,
				 size_t vl)
{
  return __riscv_vfredusum_vs_bf16m8_bf16m1 (vector, scalar, vl);
}
...
{
  return __riscv_vfredusum_vs_bf16mf4_bf16m1_m (mask, vector, scalar, vl);
}
...
test_vfredusum_vs_bf16mf2_bf16m1_m (vbool32_t mask, vbfloat16mf2_t vector,
				    vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16mf2_bf16m1_m (mask, vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m1_bf16m1_m (vbool16_t mask, vbfloat16m1_t vector,
				   vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m1_bf16m1_m (mask, vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m2_bf16m1_m (vbool8_t mask, vbfloat16m2_t vector,
				   vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m2_bf16m1_m (mask, vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m4_bf16m1_m (vbool4_t mask, vbfloat16m4_t vector,
				   vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m4_bf16m1_m (mask, vector, scalar, vl);
}
...
test_vfredusum_vs_bf16m8_bf16m1_m (vbool2_t mask, vbfloat16m8_t vector,
				   vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m8_bf16m1_m (mask, vector, scalar, vl);
}
...
test_vfredusum_vs_bf16mf4_bf16m1_rm (vbfloat16mf4_t vector,
				     vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16mf4_bf16m1_rm (vector, scalar,
						 __RISCV_FRM_RNE, vl);
}
...
test_vfredusum_vs_bf16mf2_bf16m1_rm (vbfloat16mf2_t vector,
				     vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16mf2_bf16m1_rm (vector, scalar,
						 __RISCV_FRM_RNE, vl);
}
...
test_vfredusum_vs_bf16m1_bf16m1_rm (vbfloat16m1_t vector, vbfloat16m1_t scalar,
				    size_t vl)
{
  return __riscv_vfredusum_vs_bf16m1_bf16m1_rm (vector, scalar, __RISCV_FRM_RNE,
						vl);
}
...
test_vfredusum_vs_bf16m2_bf16m1_rm (vbfloat16m2_t vector, vbfloat16m1_t scalar,
				    size_t vl)
{
  return __riscv_vfredusum_vs_bf16m2_bf16m1_rm (vector, scalar, __RISCV_FRM_RNE,
						vl);
}
...
test_vfredusum_vs_bf16m4_bf16m1_rm (vbfloat16m4_t vector, vbfloat16m1_t scalar,
				    size_t vl)
{
  return __riscv_vfredusum_vs_bf16m4_bf16m1_rm (vector, scalar, __RISCV_FRM_RNE,
						vl);
}
...
test_vfredusum_vs_bf16m8_bf16m1_rm (vbfloat16m8_t vector, vbfloat16m1_t scalar,
				    size_t vl)
{
  return __riscv_vfredusum_vs_bf16m8_bf16m1_rm (vector, scalar, __RISCV_FRM_RNE,
						vl);
}
...
test_vfredusum_vs_bf16mf4_bf16m1_rm_m (vbool64_t mask, vbfloat16mf4_t vector,
				       vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16mf4_bf16m1_rm_m (mask, vector, scalar,
						   __RISCV_FRM_RNE, vl);
}
...
test_vfredusum_vs_bf16mf2_bf16m1_rm_m (vbool32_t mask, vbfloat16mf2_t vector,
				       vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16mf2_bf16m1_rm_m (mask, vector, scalar,
						   __RISCV_FRM_RNE, vl);
}
...
test_vfredusum_vs_bf16m1_bf16m1_rm_m (vbool16_t mask, vbfloat16m1_t vector,
				      vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m1_bf16m1_rm_m (mask, vector, scalar,
						  __RISCV_FRM_RNE, vl);
}
...
test_vfredusum_vs_bf16m2_bf16m1_rm_m (vbool8_t mask, vbfloat16m2_t vector,
				      vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m2_bf16m1_rm_m (mask, vector, scalar,
						  __RISCV_FRM_RNE, vl);
}
...
test_vfredusum_vs_bf16m4_bf16m1_rm_m (vbool4_t mask, vbfloat16m4_t vector,
				      vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m4_bf16m1_rm_m (mask, vector, scalar,
						  __RISCV_FRM_RNE, vl);
}
...
test_vfredusum_vs_bf16m8_bf16m1_rm_m (vbool2_t mask, vbfloat16m8_t vector,
				      vbfloat16m1_t scalar, size_t vl)
{
  return __riscv_vfredusum_vs_bf16m8_bf16m1_rm_m (mask, vector, scalar,
						  __RISCV_FRM_RNE, vl);
}
